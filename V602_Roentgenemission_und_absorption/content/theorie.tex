...
ist die Energiedifferenz mit der Formel $h \cdot ν = E_m - E_n$ gegeben. Wegen der festen Quantisierung der Energie,
...
Schale, auf dem das Elektron aufgenommen wird. Der Index bezieht sich auf die Schale aus der das Elektron stammt.
...
\begin{equation}\label{eq:Spektrales_Aufloesungsvermoegen}
    U = \frac{E_K}{ΔE},
\end{equation}
wobei $E_K$ die Energie des Peaks und $ΔE$ die Energiedifferenz zwischen Anfang und Ende der Halbwertsbreite des Peaks ist.\\
